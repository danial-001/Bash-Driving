        ...
        <section id="courses" className="section">
          ...
          <div className="card-grid">
            <div className="premium-card" onClick={() => scrollToSection('booking')}>
              ...
              <div className="card-price">£32<span className="pricing-period"> per hour – pricing starts</span></div>
              <p className="card-description">
        ...
        <section id="pricing" className="section">
          ...
          <div className="pricing-grid">
            <div className="pricing-card" onClick={() => scrollToSection('booking')}>
              ...
              <div className="pricing-price">£32<span className="pricing-period"> per hour – pricing starts</span></div>
              <ul className="card-features">
